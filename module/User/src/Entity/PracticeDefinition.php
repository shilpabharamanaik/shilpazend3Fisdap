 ...
 * @Table(name="fisdap2_practice_definitions")
 */
class PracticeDefinition extends EntityBaseClass
{
     ...
     * @ManyToOne(targetEntity="PracticeCategory")
     ...
     * @todo investigate the need for this...should inherit from category
     */
    protected $certification_level;
    
    /**
     * \Fisdap\Entity\EvalDefLegacy
