	...
	public function populatePatientData($patient){	
		...
		if(isset($patient['SubjectType_id'])){
			...
			if(count($oldSubjectType) == 1){
				...
				if($sName == 'Human' && $sType == 'Live'){ $newSubjId = 1; }
				if($sName == 'Human' && $sType == 'Cadaver'){ $newSubjId = 2; }
				if($sName == 'Animal' && $sType == 'Live'){ $newSubjId = 3; }
				if($sName == 'Animal' && $sType == 'Cadaver'){ $newSubjId = 4; }
				if($sName == 'Manikin' && $sType == 'Simulator'){ $newSubjId = 5; }
				if($sName == 'Manikin' && $sType == 'Other'){ $newSubjId = 6; }
			}
