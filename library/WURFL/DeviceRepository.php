...
class WURFL_DeviceRepository
{
    ...
    public function __construct(WURFL_Xml_XMLResourceManager $xmlResourceManager, WURFL_UserAgentHandlerChain $userAgentHandlerChain, WURFL_Xml_PersistenceProvider $persistenceProvider)
    {
