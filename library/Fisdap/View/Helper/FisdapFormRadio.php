 ...
 *
 * Reworked slightly from the zend formRadio helper. It now no longer wraps the
 * <input> tag inside of the <label> tag so that we can use it with the jQuery
 * UI .buttonset()
 */
class Fisdap_View_Helper_FisdapFormRadio extends Zend_View_Helper_FormElement
{
    /**
     * Input type to use
     * @var string
