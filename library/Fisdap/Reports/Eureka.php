    ...
    public function getRawEurekaData($procedure_types)
    {
        ...
        foreach ($procedure_types as $pro_type) {
            if (!empty($selected_skills[$pro_type])) {
                $raw_data[$pro_type] = $repo->getEurekaProcedureData(
                    $pro_type,
        ...
        foreach ($selected_skills as $type => $pro_ids) {
            ...
            if ($pro_ids) {
                foreach ($pro_ids as $id) {
                    if ($type == "other") {
                        $procedure_entity_name = "OtherProcedure";
                    } elseif ($type == "iv") {
                        $procedure_entity_name = "IvProcedure";
                    } else {
                        $procedure_entity_name = "AirwayProcedure";
                    }
