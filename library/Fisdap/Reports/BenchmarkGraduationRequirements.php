<?php
/**
 * Class Fisdap_Reports_BenchmarkGraduationRequirements
 * This is the Benchmark Graduation Requirements Report class
 * Refer to Fisdap_Reports_Report for more documentation
 */
class Fisdap_Reports_BenchmarkGraduationRequirements extends Fisdap_Reports_Report
{
    public $header = '';
    ...
    public function runReport()
    {
        ...
        $logger->debug(var_dump($this->config));
        ...
        //make shiftSites "field/clinical/lab"?
        $dataOptions['shiftSites'] = array('field', 'clinical', 'lab');
