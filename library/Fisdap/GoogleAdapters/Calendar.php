...
class Fisdap_GoogleAdapters_Calendar
{
    ...
    public static function authMe($username, $password)
    {
    ...
    public static function outputCalendarList($client)
    {
    ...
    public static function outputCalendar($client)
    {
        $gdataCal = new Zend_Gdata_Calendar($client);
    ...
    public static function createEvent($client, $title, $desc, $duration, $start = null, $where = null, $tzOffset = '-06')
    {
        if ($start == null) {
            $start = new DateTime();
        }
