(function ($){
  ...
  var WorldMap = function (params)
  {
    ...
    this.resize();
				...
				jQuery(".state-anchor").click(function(e){
							e.preventDefault();
							var code = $(this).attr("data-abbreviation").toLowerCase();
				...
				/*
							...
							var path = jQuery("#jqvamp1_" + code);
							path.css("opacity", "0.7");
							console.log(path);
				}, function(){
							var code = jQuery(this).attr("id").toLowerCase();
							var name = jQuery(this).text();
						 var path = jQuery("#jqvamp1_" + code);
						 path.css("opacity", "1");
										console.log(path);
    ...
    bindZoomButtons: function ()
    {
      ...
      this.container.find('.jqvmap-zoomin').click(function ()
      {
        if (map.zoomCurStep < map.zoomMaxStep)
        {
          ...
          jQuery('#zoomSlider').css('top', parseInt(jQuery('#zoomSlider').css('top')) - sliderDelta);
        }
      });
