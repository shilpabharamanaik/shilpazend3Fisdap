 ...
 */
class Verification extends Timestampable
{
    /**
     * @Id
     * @Column(type="integer")
     ...
     */
    public function setVerifiedBy(User $user = null, $requireInstructor = false, $patient = null, $shift = null)
    {
        if ($user && $requireInstructor) {
            ...
            } else if ($shift && $shift->getStudent()->program->getId() != $user->getCurrentUserContext()->getProgram()->getId()) {
                throw new InvalidPermission('This educator does not belong to the same program as student.');
            }
        }
