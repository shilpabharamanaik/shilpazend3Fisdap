...
$updateCustomerCommand = new UpdateCustomerCommand($customerRepository, $customerTransformer);

try {
    $customer = $updateCustomerCommand->handle($customerBuilder);
    var_dump($customer);
