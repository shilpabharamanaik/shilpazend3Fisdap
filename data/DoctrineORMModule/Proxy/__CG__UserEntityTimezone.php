 ...
 */
class Timezone extends \User\Entity\Timezone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'programSettings', 'standard_offset', 'is_dst', 'mysql_offset', 'icalendar_name', 'icalendar_definition', 'id', 'name', 'useDNADFlag', 'entityRepository'];
        }
