 ...
 */
class Window extends \User\Entity\Window implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'program', 'slot', 'active', 'start_date', 'end_date', 'offset_type_start', 'offset_value_start', 'offset_type_end', 'offset_value_end', 'default_window', 'constraints', 'useDNADFlag', 'entityRepository'];
        }
