 ...
 */
class Profession extends \User\Entity\Profession implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'certifications', 'report_categories', 'useDNADFlag', 'entityRepository'];
        }
