...
class Zend_Session_Namespace extends Zend_Session_Abstract implements IteratorAggregate
{
    ...
    /**
     * lock() - mark a namespace as readonly
     *
     * @return void
     */
    ...
    /**
     * unlock() - unmark a namespace to enable read & write
     *
     * @return void
     */
    ...
    /**
     * unlockAll() - unmark all namespaces to enable read & write
     *
     * @return void
     */
    ...
    public function __set($name, $value)
    {
        if (isset(self::$_namespaceLocks[$this->_namespace])) {
             ...
             */
            require_once 'Exception.php';
            throw new Zend_Session_Exception('This namespace has been marked as read-only.');
        }
